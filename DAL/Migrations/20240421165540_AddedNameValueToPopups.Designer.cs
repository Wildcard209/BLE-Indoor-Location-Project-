...
namespace DAL.Migrations
{
    ...
    [Migration("20240421165540_AddedNameValueToPopups")]
    partial class AddedNameValueToPopups
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("80fe6616-4ecd-4c84-9a23-c6f2f8b4880b"),
                            Name = "None",
                            NormalizedName = "NONE"
                        },
                        new
                        {
                            Id = new Guid("8573a0b6-0783-46de-acb2-66a1ad484d5a"),
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = new Guid("4edbb6b8-ad08-4db3-b2f6-fe6883b05576"),
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("DAL.Models.MapInfo", b =>
                {
                    ...
                    b.HasOne("DAL.Models.Html", "CurrentHtml")
                        .WithMany()
                        .HasForeignKey("CurrentHtmlId");
